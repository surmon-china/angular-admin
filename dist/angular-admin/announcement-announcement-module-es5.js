...
var AnnouncementComponent = /** @class */ (function () {
    function AnnouncementComponent(fb, httpService) {
        this.fb = fb;
    ...
    Object.defineProperty(AnnouncementComponent.prototype, "currentListTotal", {
        // 当前数据数量
        get: function () {
            var pagination = this.announcements.pagination;
    ...
    // 解析 Markdown
    AnnouncementComponent.prototype.parseMarkdown = function (content) {
        return marked__WEBPACK_IMPORTED_MODULE_1___default()(content);
    };
    // 判断公告类型
    AnnouncementComponent.prototype.isState = function (state) {
        return this.publishState === state;
    };
    // 切换公告类型
    AnnouncementComponent.prototype.switchState = function (state) {
    ...
    // 重置编辑表单
    AnnouncementComponent.prototype.resetEditForm = function () {
        this.editForm.reset(DEFAULT_EDIT_FORM);
        this.activeAnnouncement = null;
    };
    // 重置搜索
    AnnouncementComponent.prototype.resetSearchForm = function () {
        this.searchForm.reset(DEFAULT_SEARCH_FORM);
    };
    // 修改公告
    AnnouncementComponent.prototype.editAnnouncement = function (announcement) {
        this.activeAnnouncement = lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"](announcement);
        this.editForm.reset(announcement);
    };
    // 提交表单
    AnnouncementComponent.prototype.submitEditForm = function (announcement) {
    ...
    // 提交搜索
    AnnouncementComponent.prototype.submitSearchForm = function () {
        if (this.searchForm.valid) {
            this.getAnnouncements();
        }
    };
    // 删除公告弹窗
    AnnouncementComponent.prototype.openDelModal = function (announcement) {
        this.activeAnnouncement = lodash__WEBPACK_IMPORTED_MODULE_2__["cloneDeep"](announcement);
        this.delModal.show();
    };
    // 删除弹窗取消
    AnnouncementComponent.prototype.canceldDelModal = function () {
        this.delModal.hide();
        this.activeAnnouncement = null;
    };
    // 批量删除公告弹窗
    AnnouncementComponent.prototype.openBatchDelModal = function () {
        this.activeAnnouncement = null;
        this.delModal.show();
    };
    // 多选切换
    AnnouncementComponent.prototype.handleBatchSelectChange = function (isSelect) {
        var data = this.announcements.data;
        var selectedIds = this.selectedAnnouncements;
        this.selectedAnnouncements = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_9__["handleBatchSelectChange"])({ data: data, selectedIds: selectedIds, isSelect: isSelect });
    };
    // 单个切换
    AnnouncementComponent.prototype.handleItemSelectChange = function () {
        var data = this.announcements.data;
        var selectedIds = this.selectedAnnouncements;
        var result = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_9__["handleItemSelectChange"])({ data: data, selectedIds: selectedIds });
        this.announcementsSelectAll = result.all;
        this.selectedAnnouncements = result.selectedIds;
    };
    // 分页获取公告
    AnnouncementComponent.prototype.handlePageChanged = function (event) {
        this.getAnnouncements({ page: event.page });
    };
    // 刷新
    AnnouncementComponent.prototype.refreshAnnouncements = function () {
        this.getAnnouncements({ page: this.announcements.pagination.current_page });
    };
    // 获取公告
    AnnouncementComponent.prototype.getAnnouncements = function (params) {
        var _this = this;
        ...
        return Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_9__["humanizedLoading"])(this.fetching, ELoading.List, this.httpService
            ...
            _this.announcements = announcements.result;
            _this.selectedAnnouncements = [];
            _this.announcementsSelectAll = false;
        }));
    };
    // 添加公告
    AnnouncementComponent.prototype.addAnnouncement = function (announcement) {
        var _this = this;
        return this.httpService.post(this.apiPath, announcement)
            .then(function (_) {
            _this.resetEditForm();
            _this.refreshAnnouncements();
        });
    };
    // 更新公告
    AnnouncementComponent.prototype.putAnnouncement = function (announcement) {
        var _this = this;
        return this.httpService.put(this.apiPath + "/" + this.activeAnnouncement._id, Object.assign(this.activeAnnouncement, announcement))
            .then(function (_) {
            _this.resetEditForm();
            _this.refreshAnnouncements();
            _this.activeAnnouncement = null;
        });
    };
    // 删除公告
    AnnouncementComponent.prototype.doDelAnnouncement = function () {
        var _this = this;
        this.httpService
    ...
    // 批量删除
    AnnouncementComponent.prototype.doDelAnnouncements = function () {
        var _this = this;
        this.httpService
