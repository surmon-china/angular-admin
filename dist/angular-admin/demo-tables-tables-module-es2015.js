...
let BasicTablesService = class BasicTablesService {
    constructor() {
...
let BorderedTableComponent = class BorderedTableComponent {
    constructor(basicTablesService) {
        this.basicTablesService = basicTablesService;
        this.metricsTableData = basicTablesService.metricsTableData;
    }
};
BorderedTableComponent.ctorParameters = () => [
...
let CondensedTableComponent = class CondensedTableComponent {
    constructor(basicTablesService) {
        this.basicTablesService = basicTablesService;
        this.peopleTableData = basicTablesService.peopleTableData;
    }
};
CondensedTableComponent.ctorParameters = () => [
    { type: _basicTables_service__WEBPACK_IMPORTED_MODULE_2__["BasicTablesService"] }
];
...
let ContextualTableComponent = class ContextualTableComponent {
    constructor() { }
};
...
let HoverTableComponent = class HoverTableComponent {
    constructor(basicTablesService) {
        this.basicTablesService = basicTablesService;
        this.metricsTableData = basicTablesService.metricsTableData;
    }
};
HoverTableComponent.ctorParameters = () => [
    { type: _basicTables_service__WEBPACK_IMPORTED_MODULE_2__["BasicTablesService"] }
];
...
let ResponsiveTableComponent = class ResponsiveTableComponent {
    constructor() { }
};
...
let StripedTableComponent = class StripedTableComponent {
    constructor(basicTablesService) {
        this.basicTablesService = basicTablesService;
        this.smartTableData = basicTablesService.smartTableData;
    }
};
StripedTableComponent.ctorParameters = () => [
    { type: _basicTables_service__WEBPACK_IMPORTED_MODULE_2__["BasicTablesService"] }
];
...
//# sourceMappingURL=demo-tables-tables-module-es2015.js.map