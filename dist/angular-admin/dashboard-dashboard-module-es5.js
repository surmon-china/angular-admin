...
var DashboardComponent = /** @class */ (function () {
    ...
    DashboardComponent.prototype.getStatisticsData = function () {
        var _this = this;
        return Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_4__["humanizedLoading"])(this.fetching, ELoading.Statistics, this.httpService
            ...
            _this.statistics = statistics.result;
        }));
    };
    DashboardComponent.prototype.getGaToken = function () {
        return Promise.resolve('token');
    };
    DashboardComponent.prototype.instanceGa = function (token) {
        ...
        gapi.analytics.ready(function () {
            ...
            var getPieChart = function (dimensions, container, title) {
            ...
            var countryChart = getPieChart('ga:country', 'pie-country', '国家地区');
            var cityChart = getPieChart('ga:city', 'pie-city', '城市');
            var browserChart = getPieChart('ga:browser', 'pie-browser', '浏览器');
    ...
    DashboardComponent.prototype.initGaScript = function () {
    ...
    DashboardComponent.prototype.initGAClient = function () {
