...
let CommentDetailComponent = class CommentDetailComponent {
    constructor(fb, route, httpService) {
        this.fb = fb;
        this.route = route;
    ...
    // 重置表单
    updateEditForm(comment) {
        this.editForm.reset(Object.assign({}, Object.assign({}, comment), {
    ...
    getCommentDetail() {
        Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_8__["humanizedLoading"])(this.fetching, ELoading.GetDetail, this.httpService
            ...
            if (this.comment.post_id !== _app_pages_comment_comment_constants__WEBPACK_IMPORTED_MODULE_9__["ECommentPostType"].Guestbook) {
    ...
    submitComment() {
        ...
        const putComment = Object.assign({}, this.comment, {
...
CommentDetailComponent.ctorParameters = () => [
...
let CommentListComponent = class CommentListComponent {
    ...
    batchSelectChange(isSelect) {
        ...
        this.selectedComments = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_10__["handleBatchSelectChange"])({ data, selectedIds, isSelect });
    ...
    itemSelectChange() {
        const data = this.comments.data;
        const selectedIds = this.selectedComments;
        const result = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_10__["handleItemSelectChange"])({ data, selectedIds });
    ...
    updateCommentsState(state, comment) {
        ...
        const post_ids = (comment ? [comment.post_id] : lodash__WEBPACK_IMPORTED_MODULE_1__["uniq"](this.selectedPostIds)).filter(id => id);
    ...
    delComments() {
        ...
        const comment_ids = this.todoDelCommentId ? [this.todoDelCommentId] : lodash__WEBPACK_IMPORTED_MODULE_1__["uniq"](this.selectedComments);
        const post_ids = (delSingleComment && todoDelComment
            ? [todoDelComment.post_id]
            : lodash__WEBPACK_IMPORTED_MODULE_1__["uniq"](this.selectedPostIds)).filter(id => id);
