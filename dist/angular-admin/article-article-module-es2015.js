...
function buildLevelCategories(categories, selectedIds) {
    const todoDeletes = [];
    const newCategories = [];
    const todoCategories = lodash__WEBPACK_IMPORTED_MODULE_0__["cloneDeep"](categories);
    // 级别数据构造
...
let ArticleCategoryComponent = class ArticleCategoryComponent {
    ...
    getCategories() {
        Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_7__["humanizedLoading"])(this.fetching, ELoading.Get, this.httpService
            ...
            this.categories.data = Object(_app_pages_article_article_service__WEBPACK_IMPORTED_MODULE_5__["buildLevelCategories"])(this.categories.data);
        }));
    }
    // 添加分类
...
ArticleCategoryComponent.ctorParameters = () => [
...
let ArticleCategoryAddComponent = class ArticleCategoryAddComponent {
    constructor(fb) {
...
ArticleCategoryAddComponent.ctorParameters = () => [
...
let ArticleCategoryListComponent = class ArticleCategoryListComponent {
    constructor() {
    ...
    // 多选切换
    batchSelectChange(isSelect) {
        const data = this.categories.data;
        const selectedIds = this.selectedCategories;
        this.selectedCategories = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_2__["handleBatchSelectChange"])({ data, selectedIds, isSelect });
    }
    // 单个切换
    itemSelectChange() {
        const data = this.categories.data;
        const selectedIds = this.selectedCategories;
        const result = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_2__["handleItemSelectChange"])({ data, selectedIds });
...
let ArticleEditCategoryComponent = class ArticleEditCategoryComponent {
    constructor(httpService) {
        this.httpService = httpService;
...
ArticleEditCategoryComponent.ctorParameters = () => [
...
let ArticleEditExtendComponent = class ArticleEditExtendComponent {
    constructor() {
...
let ArticleEditMainComponent = class ArticleEditMainComponent {
...
ArticleEditMainComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
...
let ArticleEditSubmitComponent = class ArticleEditSubmitComponent {
    constructor() {
...
let ArticleEditComponent = class ArticleEditComponent {
    constructor(elem, router, route, httpService) {
        this.elem = elem;
        this.router = router;
        this.route = route;
        this.httpService = httpService;
    ...
    submitArticle() {
        ...
        Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_5__["humanizedLoading"])(this.fetching, ELoading.Post, (isSubmitNewPost
            ...
            : this.httpService.put(`${this.apiPath}/${this.article._id}`, this.article)).then(article => {
            if (isSubmitNewPost) {
...
let ArticleListComponent = class ArticleListComponent {
    ...
    batchSelectChange(isSelect) {
        ...
        this.selectedArticles = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_7__["handleBatchSelectChange"])({ data, selectedIds, isSelect });
    }
    // 文章列表单个切换
    itemSelectChange() {
        const data = this.articles.data;
        const selectedIds = this.selectedArticles;
        const result = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_7__["handleItemSelectChange"])({ data, selectedIds });
    ...
    getCategories() {
        Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_7__["humanizedLoading"])(this.fetching, ELoading.GetCategoryList, this.httpService
            ...
            .then(categories => {
            this.categories = categories.result;
            this.categories.data = Object(_app_pages_article_article_service__WEBPACK_IMPORTED_MODULE_8__["buildLevelCategories"])(this.categories.data);
        }));
    }
    // 对于所有修改进行相应统一处理
    patchArticles(data) {
    ...
    moveToRecycle(articleIds) {
        ...
        const state = _app_constants_state__WEBPACK_IMPORTED_MODULE_9__["EPublishState"].Recycle;
        this.patchArticles({ article_ids, state });
    }
    // 恢复文章（移至草稿）
    moveToDraft(articleIds) {
        const article_ids = articleIds || this.selectedArticles;
        const state = _app_constants_state__WEBPACK_IMPORTED_MODULE_9__["EPublishState"].Draft;
        this.patchArticles({ article_ids, state });
    }
    // 快速发布（移至已发布）
    moveToPublished(articleIds) {
        const article_ids = articleIds || this.selectedArticles;
        const state = _app_constants_state__WEBPACK_IMPORTED_MODULE_9__["EPublishState"].Published;
        this.patchArticles({ article_ids, state });
    }
    // 彻底删除文章（批量删除）
    delArticles() {
        const article_ids = this.todoDelArticleId ? [this.todoDelArticleId] : this.selectedArticles;
...
let ArticleTagComponent = class ArticleTagComponent {
    // 构造函数
    constructor(fb, httpService) {
        this.fb = fb;
        this.httpService = httpService;
    ...
    batchSelectChange(isSelect) {
        ...
        this.selectedTags = Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_7__["handleBatchSelectChange"])({ data, selectedIds, isSelect });
    }
    // 单个切换
    itemSelectChange() {
        const data = this.tags.data;
    ...
    // 添加标签
    addTag(tag) {
        return Object(_app_pages_pages_service__WEBPACK_IMPORTED_MODULE_7__["humanizedLoading"])(this.fetching, ELoading.Post, this.httpService.post(this.apiPath, tag).then(_ => {
            this.resetEditForm();
...
ArticleTagComponent.ctorParameters = () => [
    { type: _angular_forms__WEBPACK_IMPORTED_MODULE_5__["FormBuilder"] },
    { type: _app_services__WEBPACK_IMPORTED_MODULE_6__["SaHttpRequesterService"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
